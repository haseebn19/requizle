        ...
        <form onSubmit={handleSubmit} className="w-full">
            <div className="relative">
                <input
                    ...
                    className="w-full p-4 pr-14 rounded-xl border-2 border-slate-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all font-medium text-lg disabled:bg-slate-50 disabled:text-slate-500"
                    autoFocus
                />
                <button
                    type="submit"
            ...
            {submittedAnswer && (
                <div className="mt-4 p-4 bg-slate-50 rounded-lg border border-slate-200">
                    ...
                    <p className="text-slate-800 font-medium mt-1">{question.answer}</p>
                </div>
            )}
        </form>
    );
